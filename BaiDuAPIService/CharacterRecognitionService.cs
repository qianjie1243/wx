...
namespace BaiDuAPIService
{
    ...
    public class CharacterRecognitionService
    {
        ...
        /// <returns></returns>
        public object GetGeneral_basic(int type, string path, string language_type, string detect_direction, string probability, string AK, string SK)
        {
            try
            {
                var url = "";
                ...
                var result = Utils.HttpPost(url + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
        ...
        /// <returns></returns>
        public object GetIdNumber(string path, string AK, string SK, string id_card_side, string detect_direction)
        {
            try
            {
                ...
                var result = Utils.HttpPost(idcardurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object GetBankcard(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(bankcardurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getpassport(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(businesslicenseurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <returns></returns>
        public object Getdrivinglicense(string path, string AK, string SK, string detect_direction)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}&detect_direction={detect_direction}";
                var result = Utils.HttpPost(drivinglicenseurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <returns></returns>
        public object Getvehiclelicense(string path, string AK, string SK, string detect_direction, string vehicle_license_side)
        {
            try
            {
                ...
                var result = Utils.HttpPost(vehiclelicenseurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Gethouseholdregister(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(householdregisterurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getbirthcertificate(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(birthcertificateurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object GetHKMacauexitentrypermit(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(HKMacauexitentrypermiturl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Gettaiwanexitentrypermit(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(taiwanexitentrypermiturl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <returns></returns>
        public object Getbusinesslicense(string path, string AK, string SK, string detect_direction)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}&detect_direction={detect_direction}";
        ...
        /// <returns></returns>
        public object Getvatinvoice(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(vatinvoiceurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="detect_direction">是否检测图像朝向，默认不检测，即：false。朝向是指输入图像是正常方向、逆时针旋转90/180/270度。可选值包括:- true：检测朝向；- false：不检测朝向。</param>
        /// <returns></returns>
        public object Getreceipt(string path, string AK, string SK, string detect_direction)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}&detect_direction={detect_direction}";
                var result = Utils.HttpPost(receipturl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Gettrainticket(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(trainticketurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Gettaxireceipt(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(taxireceipturl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getquotainvoice(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(quotainvoiceurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getvehicleinvoice(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(vehicleinvoiceurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object GetHandWriting(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(handwritingurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getbusinesscard(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(businesscardurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <returns></returns>
        public object Getlicenseplate(string path, string AK, string SK, bool multi_detect)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}&multi_detect={multi_detect}";
                var result = Utils.HttpPost(licenseplateurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getvehiclecertificate(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(vehiclecertificateurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getvincode(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(vincodeurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getqrcode(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(qrcodeurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <param name="SK"></param>
        /// <returns></returns>
        public object Getlottery(string path, string AK, string SK)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}";
                var result = Utils.HttpPost(lotteryurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
        ...
        /// <returns></returns>
        public object Getlinsurancedocuments(string path, string AK, string SK,string rkv_business)
        {
            try
            {
                string str = $"image={HttpUtility.UrlEncode(Thumbnail.ImgToBase64String(path))}&rkv_business={rkv_business}";
                var result = Utils.HttpPost(linsurancedocumentsurl + "?access_token=" + AccessToken.getAccessToken(AK, SK), str);
                JObject jo = (JObject)JsonConvert.DeserializeObject(result);
                return jo;
            }
            catch (Exception)
