...
namespace Redis.CacheBase
{
    public interface ICache
    {
        ...
        /// <param name="cacheKey">键</param>
        /// <returns></returns>
        T ReadHash<T>(string key, string dataKey, long dbId = 0) where T : class;
        ...
        void WriteHash<T>(string Key, string dataKey, T value, long dbId = 0) where T : class;

        /// <summary>
        /// 移除指定数据缓存
        /// </summary>
        /// <param name="cacheKey">键</param>
        void RemoveHash(string Key, string dataKey, long dbId = 0);

        /// <summary>
        /// 移除缓存
        /// </summary>
        void RemoveHash(string Key, long dbId = 0);
