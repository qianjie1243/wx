...
namespace Common
{
    public class SM4
    {
        ...
                /// <param name="plainText">明文</param>
                /// <returns>返回密文</returns>
        public static string Base64_Encrypt_ECB(string secretKey, bool hexString, string plainText)
        {
            Sm4Context ctx = new Sm4Context();
            ctx.isPadding = true;
            ctx.mode = Sm4.SM4_ENCRYPT;
...
        public static string Decrypt_ECB(string secretKey, bool hexString, string cipherText)
        ...
                /// <param name="cipherText">密文</param>
                /// <returns>返回明文</returns>
        public static string Base64_Decrypt_ECB(string secretKey, bool hexString, string cipherText)
        {
            Sm4Context ctx = new Sm4Context();
            ctx.isPadding = true;
            ctx.mode = Sm4.SM4_DECRYPT;
